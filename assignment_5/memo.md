...
I believe that there are two significant opportunities for this application to be used in the industry. The first potential applications is to be used by companies that are looking for talent in multiple positions. This can be used to narrow down the application pool by seeing where the skill gaps are and identifying whether the skill gaps are things that can be changed quickly or whether they need to find people with more experience. This also be used to identify the resumes that the most are the most relevant based on the number of keywords that appear in the resume. The application could be licensed out and rewritten to be integrated within a company's HR department and be able to find these results live. 

The second potential application is to have this service available to students and other job seekers. This can be used to give constructive criticism to tailor their resumes for the kind of positions they are looking for. Doing it this way can be very beneficial for the job seekers to learn what the best way to phrase things on your resume in order to make sure that they are considered a higher match. 
